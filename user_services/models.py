...
class Like(models.Model):
    user = models.ForeignKey(NormalUser, on_delete=models.CASCADE, related_name="likes")
...
class Comment(models.Model):
    author = models.ForeignKey(
        NormalUser, on_delete=models.CASCADE, related_name="author"
    )
...
class Message(models.Model):
    author_message = models.ForeignKey(
        settings.AUTH_USER_MODEL, on_delete=models.CASCADE, related_name="send_message"
    )
    recipient = models.ForeignKey(
        settings.AUTH_USER_MODEL,
        on_delete=models.CASCADE,
        related_name="accepted_message",
    )
