...
ORDINARY_USER, MANAGER, SUPER_ADMIN = ("ordinary_user", "manager", "super_admin")
...
class UserConfirmation(models.Model):
    ...
    user = models.ForeignKey("user_check.User", models.CASCADE, "verify_codes")
...
class User(AbstractUser, BaseModel):
    ...
    AUTH_STATUS = ((NEW, NEW), (CODE_VERIFIED, CODE_VERIFIED), (DONE, DONE))
    ...
    phone_number = models.CharField(
        max_length=12, null=True, blank=True, unique=True, validators=[_validate_phone]
    )
    ...
    def check_email(self):
        if self.email:
            normalized_email = (
                self.email.lower()
            )  # SamanDar@gmail.com -> samandar@gmail.com
