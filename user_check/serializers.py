...
class SignUpSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = User
        fields = ("guid", "auth_type", "auth_status")
        extra_kwargs = {
    ...
    def auth_validate(attrs):
        ...
        if input_type == "email":
            data = {"email": attrs.get("email_phone_number"), "auth_type": VIA_EMAIL}
            ...
            data = {"success": False, "message": "Must send email or phone number"}
            raise ValidationError(data)
